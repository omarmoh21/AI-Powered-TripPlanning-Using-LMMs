      ...
      <div className="relative bg-nile-blue min-h-screen flex items-center">
        ...
        <div className="relative mx-auto max-w-7xl py-24 px-6 sm:py-32 lg:px-8">
          <div className="max-w-3xl">
            {/* Logo and Enhanced heading with Egyptian styling */}
            <div className="mb-8">
              <div className="flex items-center mb-6">
                <img
                  src="/src/assets/LOGO.jpg"
                  alt="Ray7 Masr Logo"
                  className="h-16 w-16 mr-4 rounded-full object-cover shadow-lg"
                  style={{
                    filter: 'brightness(1.1) contrast(1.1)',
                    clipPath: 'circle(45% at 50% 50%)'
                  }}
                />
                <div className="inline-flex items-center px-4 py-2 rounded-full bg-pharaoh-gold/20 border border-pharaoh-gold/30">
